...
BASE_PRICES = {
    # --- HIT PRZEDSPRZEDAŻE I NOWOŚCI PS5 ---
    "astro bot ps5": 150,
    "black myth wukong ps5": 160,
    "silent hill 2 ps5": 160,
    "dragon ball sparking zero ps5": 120,
    "star wars outlaws ps5": 60,
    "helldivers 2 ps5": 70,
    "warhammer space marine 2 ps5": 70,
    "final fantasy 7 rebirth ps5": 120,
    "dragons dogma 2 ps5": 65 , 
    "rise of the ronin ps5": 90,   
    "stellar blade ps5": 160,
    "tekken 8 ps5": 90,
    # --- SPOTOWE I PIŁKA NOŻNA ---
    "fc 25 ps4": 110,
    "fc 25 ps5": 150,
    "fc 24 ps4": 40,
    "fc 24 ps5": 60,
    ...
    "kingdom come deliverance ps4": 30,
    "baldurs gate 3 ps5": 180,
    "baldur's gate 3 ps5": 180,
    "lies of p ps4": 110,
    "lies of p ps5": 120,
    "lords of the fallen ps5": 90,
    "avatar frontiers of pandora ps5": 110,
    # --- THE LAST OF US / UNCHARTED ---
    "last of us ps4": 40,
    "last of us part 1 ps5": 140,
    "last of us part 2 ps4": 70,
    "last of us part 2 remastered ps5": 120,
    "uncharted 4 ps4": 20,
    ...
    "spiderman 2 ps5": 120,
    "guardians of the galaxy ps4": 35,
    "guardians of the galaxy ps5": 45,
    ...
    "dark souls 3 ps4": 40,
    "sekiro ps4": 70,
    "armored core 6 ps4": 90,
    "armored core 6 ps5": 100,
    # --- RESIDENT EVIL / HORROR ---
    "resident evil 4 ps4": 75,
    "resident evil 4 ps5": 85,
    "resident evil village ps4": 40,
    "resident evil village ps5": 50,
    "resident evil 2 ps4": 35,
    "resident evil 3 ps4": 35,
    "dead space ps5": 90,
    "alan wake 2 ps5": 120,
    "the calisto protocol ps4": 30,
    "the callisto protocol ps5": 40,
    "dying light 2 ps4": 40,
    "dying light 2 ps5": 60,
    "dying light definitive ps4": 30,
    # --- HORIZON / EXCLUSIVE SONY ---
    ...
    "assassins creed odyssey ps4": 30,
    "far cry 6 ps4": 30,
    "far cry 6 ps5": 40,
    "far cry 5 ps4": 25,
    "crew motorfest ps4": 70,
    "crew motorfest ps5": 90,
    "prince of persia the lost crown ps4": 70,
    "prince of persia the lost crown ps5": 80,
    # --- CALL OF DUTY / SHOOTERY ---
    "call of duty modern warfare ps4": 30,
    "call of duty mw2 ps5": 90,
    "call of duty mw3 ps5": 95,
    "cod mw3 ps5": 95,
    "call of duty vanguard ps4": 35,
    "call of duty vanguard ps5": 45,
    "battlefield 2042 ps4": 20,
    "battlefield 2042 ps5": 30,
    "cyberpunk 2077 phantom liberty ps5": 120,
    # --- BIATKI / CO-OP / INNE ---
    "tekken 7 ps4": 25,
